    ...
    >
      ...
      >
        <a
          ...
          href="https://www.linkedin.com/in/mynkprtp/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        <a
          className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://leetcode.com/mayankprtp/"
          target="_blank"
        >
          <Image
              src="/leetcode.png"
              ...
              quality="25"
              priority={true}
              className="h-6 w-6 rounded-full object-cover shadow-xl"
            />
        </a>
        
        <a
          className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.codechef.com/users/mayankprtp"
          target="_blank"
        >
          <Image
              src="/codechef1.png"
        ...
        <a
          className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://codeforces.com/profile/mayankprtp"
          target="_blank"
        >
          <Image
              src="/code-forces.png"
        ...
        <a
          ...
          href="https://github.com/mynkprtp/"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
